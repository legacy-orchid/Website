    ...
    <header id="header" class="bg-white-only wrapper">
       <nav class="navbar">
        <div class="navbar-header v-center">
            ...
            <a href="/ru" class="navbar-brand m-r-lg">
...
">
        ...
        <div class="collapse navbar-collapse m-n w-full" id="navbar-collapse">
            <ul class="nav navbar-nav navbar-right  font-thin hidden-xs">
                    ...
                    <li><a href="http://demo-orchid.tk">Демо</a></li>
                    <li><a href="@url('/ru/docs/')">Документация</a></li>
            </ul>
        </div>
       </nav>
</header>
...
">
                ...
                <small>Код приложения публикуется под лицензией MIT</small>
